...
Func::make('format_message', function () {
    /**
     * 格式化表单校验消息
     *
...
Func::make('format_json_message', function () {
    /**
...
Func::make('chinese_excerpt', function () {
    /**
     * 中文摘要算法
     *
...
Func::make('check_array', function () {
    /**
...
Func::make('check_string', function () {
    /**

        ...
        <div id="content" class="content full padding-b0">
            <div class="container">
                <div class="row" style="overflow: hidden;margin-bottom: 30px;position: relative;margin-top:-30px;">
                    ...
                    <div class="col-md-9 posts-archive" style="margin-bottom:-30px;padding-top:15px;">
                        ...
                        <div class="row box">
                            ...
                            @endif
                                @wpquery(['post_type' => 'page','pagename' => 'index','posts_per_page' => 10])
                                {{ the_content() }}
                                @wpempty
                                {{ __('nothing') }}
                                @wpend
                                                        ...
                                                        <div class="post-block format-standard">
                                                            ...
                                                            <div class="post-actions">
                                                                ...
                                                                <div class="comment-count">
                                                                    <a href="{{comments_link()}}"><i class="icon-dialogue-text"></i> {{comments_number()}}
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <h3 class="post-title">
                                                    ...
                                                    @foreach($weibo as $i => $value)
                                                        ...
                                                        <li class="item">
                                                            <div class="testimonial-block">
                                                                <blockquote>
                                                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla convallis egestas
                                                                        rhoncus. Donec facilisis fermentum sem, ac viverra ante luctus vel. Donec vel
                                                                        mauris
                                                                        quam.</p>
                                                                </blockquote>
                                                                <div class="testimonial-avatar">
